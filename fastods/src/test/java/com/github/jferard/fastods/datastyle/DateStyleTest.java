...
import com.github.jferard.fastods.testlib.*;
...
public class DateStyleTest {
    ...
    public final void testWithFormat1() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.DDMMYY).build();
    ...
    public final void testWithFormat2() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.DDMMYYYY).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
    ...
    public final void testWithFormat3() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.MMMM).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithFormat4() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.MMYY).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithFormat5() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.TMMMMYYYY).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithFormat6() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.WW).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithFormat7() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").dateFormat(DateStyle.Format.YYYYMMDD).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithLanguage() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").language("fr").build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
    ...
    public final void testWithLocale() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").locale(this.locale).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithOrder() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").automaticOrder(true).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
                "<number:date-style style:name=\"test\" number:language=\"en\" number:country=\"US\" " +
    ...
    public final void testWithVolatile() throws IOException {
        final DateStyle ds = this.factory.dateStyleBuilder("test").volatileStyle(false).build();
        final StringBuilder sb = new StringBuilder();
        ds.appendXMLContent(this.util, sb);
        DomTester.assertEquals(
