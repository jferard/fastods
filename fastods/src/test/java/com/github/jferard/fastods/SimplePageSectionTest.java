...
public class SimplePageSectionTest {
	...
	public final void testAlmostEmptyToMasterStyle() throws IOException {
		final PageSection header = PageSection
				.simpleBuilder().build();
	...
	public final void testFourMarginsAndMinHeightToAutomaticStyle()
		...
		final TextStyle ts = TextProperties.builder().fontStyleItalic()
				.buildStyle("style");
		final Header header = PageSection
				.simpleBuilder().marginTop(SimpleLength.pt(10.0))
	...
	public final void testMarginsAndMinHeightToAutomaticStyle()
		...
		final TextStyle ts = TextProperties.builder().fontStyleItalic()
				.buildStyle("style");
		final Header header = PageSection
				.simpleBuilder().allMargins(SimpleLength.pt(10.0))
				.minHeight(SimpleLength.pt(120.0)).styledContent("text", ts).buildHeader();
		final StringBuilder sb = new StringBuilder();
		header.appendPageSectionStyleXMLToAutomaticStyle(this.util, sb);
		DomTester.assertEquals("<style:header-style>"
	...
	public final void testSimpleStyledTextToAutomaticStyle()
		...
		final Footer footer = PageSection
				.simpleBuilder().styledContent(text, ts)
				.buildFooter();
		final StringBuilder sb = new StringBuilder();
	...
	public final void testSimpleStyledTextToMasterStyle() throws IOException {
		final TextStyle ts = TextProperties.builder().buildStyle("test");
		final PageSection footer = PageSection
				.simpleBuilder()
