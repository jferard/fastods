...
public class Header {
	 ...
	 * 
	 * @param odsFile
	 *            - The OdsFile to which this header belongs to.
	 */
	...
	/**
	 * Adds a TextStyle and text to the header region specified by
	 * nHeaderRegion.<br>
	 ...
	 * @param nHeaderRegion
	 *            One of : Header.FLG_REGION_LEFT, Header.FLG_REGION_CENTER or
	 *            Header.FLG_REGION_RIGHT
	 * @param nParagraph
