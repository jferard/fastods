...
public class Content {
	...
	public boolean addTable(String sName) throws SimpleOdsException {
		...
		if( this.qTables.size()>=256 ) {
			throw new SimpleOdsException("Maximum table number (256) reached exception");
		}
		
		for(int n=0;n<this.qTables.size();n++) {
			Table tab =(Table)this.qTables.get(n);
			if( tab.getName().equalsIgnoreCase(sName)) return false;
		}
	...
	private boolean getContent(ZipOutputStream o) {
		...
		for (int n = 0; n < this.qTables.size(); n++) {
			Table tab = (Table) this.qTables.get(n);
			u.writeString(o, tab.toXML());
			u.writeString(o, "<office:forms form:automatic-focus=\"false\" form:apply-design-mode=\"false\"/>");
			
			// Loop through all table column styles and write the informations
			String sSytle0 = "co1";
			String sSytle1 = "co1";

			// If there is only one column style in column one, just write this info to OutputStream o
			...
			// If there is more than one column with a style, loop through all styles and
			...
			if (tab.getColumnStyles().size() > 1) {
				...
				u.writeString(o, "<table:table-column table:style-name=\""+sSytle1+"\" table:number-columns-repeated=\""+nCount+"\" table:default-cell-style-name=\""+sDefaultCellSytle0+"\"/>");
			...
			for (int r = 0; r < tab.getRows().size(); r++) {
				...
				if (tr != null) {
					...
					u.writeStringArray(o, sToPrint);
				} else {
					// Empty TableRow
					u.writeString(o,"<table:table-row table:style-name=\"ro1\">");
					u.writeString(o,"<table:table-cell table:number-columns-repeated=\""+tab.getLastCol()+"\"/>");
					u.writeString(o,"</table:table-row>");
					
				}
			}
			u.writeString(o, "</table:table>");
		}	
	...
	public boolean createContent(ZipOutputStream o) {
		...
		try {
			...
			u.writeString(o, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
			u.writeString(o, "<office:document-content xmlns:office=\"urn:oasis:names:tc:opendocument:xmlns:office:1.0\" xmlns:style=\"urn:oasis:names:tc:opendocument:xmlns:style:1.0\" xmlns:text=\"urn:oasis:names:tc:opendocument:xmlns:text:1.0\" xmlns:table=\"urn:oasis:names:tc:opendocument:xmlns:table:1.0\" xmlns:draw=\"urn:oasis:names:tc:opendocument:xmlns:drawing:1.0\" xmlns:fo=\"urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:meta=\"urn:oasis:names:tc:opendocument:xmlns:meta:1.0\" xmlns:number=\"urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0\" xmlns:presentation=\"urn:oasis:names:tc:opendocument:xmlns:presentation:1.0\" xmlns:svg=\"urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0\" xmlns:chart=\"urn:oasis:names:tc:opendocument:xmlns:chart:1.0\" xmlns:dr3d=\"urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0\" xmlns:math=\"http://www.w3.org/1998/Math/MathML\" xmlns:form=\"urn:oasis:names:tc:opendocument:xmlns:form:1.0\" xmlns:script=\"urn:oasis:names:tc:opendocument:xmlns:script:1.0\" xmlns:ooo=\"http://openoffice.org/2004/office\" xmlns:ooow=\"http://openoffice.org/2004/writer\" xmlns:oooc=\"http://openoffice.org/2004/calc\" xmlns:dom=\"http://www.w3.org/2001/xml-events\" xmlns:xforms=\"http://www.w3.org/2002/xforms\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" office:version=\"1.1\">");
			u.writeString(o, "<office:scripts/>");
			u.writeString(o, "<office:font-face-decls>");
			u.writeString(o, "<style:font-face style:name=\"Arial\" svg:font-family=\"Arial\" style:font-family-generic=\"swiss\" style:font-pitch=\"variable\"/>");
			u.writeString(o, "<style:font-face style:name=\"Lucida Sans Unicode\" svg:font-family=\"'Lucida Sans Unicode'\" style:font-family-generic=\"system\" style:font-pitch=\"variable\"/>");
			u.writeString(o, "<style:font-face style:name=\"Tahoma\" svg:font-family=\"Tahoma\" style:font-family-generic=\"system\" style:font-pitch=\"variable\"/>");
			u.writeString(o, "</office:font-face-decls>");
			/* Office automatic styles */
			u.writeString(o, "<office:automatic-styles>");
			
			for (int n = 0; n < this.qTableStyles.size(); n++) {
				TableStyle ts = (TableStyle) qTableStyles.get(n);
				u.writeString(o, ts.toXML());
			}
			u.writeString(o, "</office:automatic-styles>");

			u.writeString(o, "<office:body>");
			u.writeString(o, "<office:spreadsheet>");
			this.getContent(o);
			u.writeString(o, "</office:spreadsheet>");
			u.writeString(o, "</office:body>");
			u.writeString(o, "</office:document-content>");
	...
	public boolean setCell(int nTab, int nRow, int nCol, int valuetype, String value) throws SimpleOdsException {
	...
	public boolean setCellStyle(int nTab, int nRow, int nCol, TableStyle ts) throws SimpleOdsException {
	 ...
	 * If no TableCell was present at this nRow,nCol, create a new one with a default of TableCell.STYLE_STRING and a content of ""<br>  
	 * @param nTab
	 * @param nRow
	 * @param nCol
	 ...
	 */
	public TableCell getCell(int nTab, int nRow, int nCol) throws SimpleOdsException {
		if (nTab < 0 || nTab >= this.qTables.size()) {
			throw new SimpleOdsException("Wrong table number [" + nTab + "]");
		}
		Table tab = (Table) this.qTables.get(nTab);
	...
	public boolean setColumnStyle(int nTab, int nCol, TableStyle ts) throws SimpleOdsException {
