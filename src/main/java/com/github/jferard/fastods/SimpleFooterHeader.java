...
class SimpleFooterHeader extends FooterHeader {
	...
	SimpleFooterHeader(final SimpleFooterHeader.Type footerHeaderType,
			final List<FHParagraph> region, final String marginLeft,
			final String marginRight, final String marginTop, final String marginBottom,
			final String minHeight) {
		super(footerHeaderType, marginLeft, marginRight, marginTop, marginBottom, minHeight);
		this.region = region;
	}
