...
public abstract class FooterHeader {
	...
	public abstract void addEmbeddedStylesToStylesEntry(OdsEntryWithStyles entry);
	
	public abstract void addEmbeddedStylesToStylesEntry(OdsEntryWithStyles entry, Mode mode);
}
